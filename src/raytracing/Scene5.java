...
public class Scene5 extends Scene {
    public Scene5() {
        ...
        lights.clear();
        Light light = new Light.Distant(new Normal(5,-10,-5.001));
        ...
        // a ball
        Sphere ball = new Sphere(new Point(0,1.5,0), 1, new Shade(1,0,0),GeometricObject.MaterialType.ReflectionAndRefraction, 1.5);
        objects.add(ball);
        ...
        // floor
        Plane floor = new Plane(new Point(0,0,0), new Normal(0, 1, 0), new Shade(0x929292), GeometricObject.MaterialType.Diffuse,2);
        objects.add(floor);
        //floor.phong_n = 1000;
        floor.Ks = 0;
        floor.Ki = 0.2;
